# Generated by Django 2.2.4 on 2019-11-13 05:53
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fee_type', models.CharField(choices=[('GeneralFee', 'GeneralFee'), ('Hostel', 'Hostel'), ('Transport', 'Transport')], max_length=100)),
                ('fee_title', models.CharField(max_length=100)),
                ('note', models.TextField(max_length=300)),
                ('Class_Amount', models.CharField(blank=True, max_length=100, null=True)),
                ('Class', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='schools.Classroom')),
            ],
        ),
        migrations.CreateModel(
            name='Gallery',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_allowance', models.CharField(blank=True, max_length=100, null=True)),
                ('total_deduction', models.CharField(blank=True, max_length=100, null=True)),
                ('gross_salary', models.CharField(blank=True, max_length=100, null=True)),
                ('net_salary', models.CharField(blank=True, max_length=100, null=True)),
                ('note', models.TextField(null=True)),
                ('over_time_total_hour', models.CharField(blank=True, max_length=100, null=True)),
                ('over_time_amount', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('Payment_Method', models.CharField(blank=True, choices=[('Cheque', 'Cheque'), ('MobileMoney', 'MobileMoney'), ('Cash', 'Cash')], max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paid_status', models.CharField(choices=[('Paid', 'Paid'), ('Unpaid', 'Unpaid')], max_length=100)),
                ('Payment_Method', models.CharField(blank=True, choices=[('Cash', 'Cash'), ('Cheque', 'Cheque')], max_length=100, null=True)),
                ('Bank_Name', models.CharField(blank=True, max_length=100, null=True)),
                ('Cheque_Number', models.CharField(blank=True, max_length=100, null=True)),
                ('note', models.TextField(max_length=300)),
                ('classroom', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='schools.Classroom')),
                ('fee_amount', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='fee_am', to='schools.FeeType')),
                ('fee_type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='fee', to='schools.FeeType')),
                ('school', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='schools.School')),
                ('student', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='schools.Student')),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('payment_method', models.CharField(choices=[('Cash', 'Cash'), ('Cheque', 'Cheque')], max_length=100)),
                ('Bank_Name', models.CharField(blank=True, max_length=100, null=True)),
                ('Cheque_Number', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('note', models.TextField(max_length=100)),
                ('postal_Attachment', models.FileField(default='photo', upload_to='attachments/')),
                ('school', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='schools.School')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classroom', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='schools.Classroom')),
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='schools.School')),
                ('section', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='schools.Section')),
